...
export const i18n: Record<SupportedLanguage, Record<string, string>> = {
  zh: {
    ...
    "projects.related_research": "关联研究主题",
    "research.eyebrow": "研究",
    "research.title": "研究主题与方向",
    "research.description": "当前工作聚焦 CNV 检测算法、概率基因组建模，以及生物信息学方法向精准医疗流程的转化。",
    "research.framework_title": "研究框架",
    "research.framework_desc": "将 CNV 与计算基因组学工作组织为可快速阅读的模块，并映射到对应项目。",
    "research.metric_themes": "研究主题",
    "research.metric_projects": "关联项目",
    "research.metric_route": "作品集入口",
    "research.merged_title": "研究、项目与简历整合",
    "research.merged_desc": "为避免重复内容，Research、Projects、CV 的核心信息已合并到同一页面，并通过分区锚点导航。",
    "research.block_core": "研究核心",
    "research.block_core_desc": "研究主题、方法、应用场景与关联项目。",
    "research.block_portfolio": "项目与简历快照",
    "research.block_portfolio_desc": "项目卡片与 CV 关键条目整合展示。",
    "research.keywords": "关键词",
    "research.methods": "方法",
    "research.applications": "应用",
    "research.related_projects": "关联项目",
    ...
    "cv.integrated_work": "研究与项目合并索引",
    "cv.integrated_work_desc": "为避免重复长段内容，研究与项目的完整描述集中在对应详情页。本区仅保留索引条目，便于快速跳转。",
    "cv.integrated_research": "研究主题",
    "cv.integrated_projects": "项目条目",
    "cv.technical_skills": "技术技能",
    "cv.awards": "奖项荣誉",
    "portfolio.eyebrow": "作品集",
    "portfolio.title": "项目与简历快照",
    "portfolio.description": "将项目成果与 CV 关键信息整合展示，便于快速浏览与评估。",
    "news.eyebrow": "动态",
    "news.title": "时间线更新",
  ...
  en: {
    ...
    "projects.related_research": "Related research",
    ...
    "research.framework_title": "Research Framework",
    "research.framework_desc":
      "Focused themes in CNV and computational genomics, organized as concise modules for fast reading and clear project mapping.",
    "research.metric_themes": "Themes",
    "research.metric_projects": "Linked projects",
    "research.metric_route": "Portfolio route",
    "research.merged_title": "Themes, projects, and CV",
    "research.merged_desc":
      "To reduce duplicated content, Research, Projects, and CV information has been consolidated on one page with section anchors.",
    "research.block_core": "Research Core",
    "research.block_core_desc": "Themes, methods, applications, and linked project entries.",
    "research.block_portfolio": "Projects + CV Snapshot",
    "research.block_portfolio_desc": "Consolidated project cards and concise CV records.",
    "research.keywords": "Keywords",
    "research.methods": "Methods",
    "research.applications": "Applications",
    "research.related_projects": "Related projects",
    ...
    "cv.integrated_work": "Integrated research and projects",
    "cv.integrated_work_desc":
      "To avoid duplicated long-form text, full descriptions are consolidated on the dedicated Research and Projects pages. This section keeps indexed entries for quick navigation.",
    "cv.integrated_research": "Research themes",
    "cv.integrated_projects": "Project entries",
    "cv.technical_skills": "Technical skills",
    "cv.awards": "Awards",
    "portfolio.eyebrow": "Portfolio",
    "portfolio.title": "Projects and CV Snapshot",
    "portfolio.description":
      "A practical portfolio view that combines project outputs with concise CV sections for quick review.",
    "news.eyebrow": "News",
