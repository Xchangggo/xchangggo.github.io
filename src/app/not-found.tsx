  ...
  return (
    <Container className="flex min-h-[60vh] items-center py-10 md:py-16">
      <section className="space-y-5">
        ...
        <h1 data-i18n="not_found.title" className="font-display text-4xl text-ink md:text-5xl">Page not found</h1>
        <p data-i18n="not_found.desc" className="max-w-xl text-base leading-relaxed text-muted">
          The page you are looking for does not exist or may have moved. Return to the homepage to continue browsing.
        </p>
        <Link
          href="/"
          data-i18n="not_found.back_home"
